...
export class PrismaTaskRepository implements ITaskRepository {
  ...
  async createTask(createTaskDto: CreateTaskDto, userId: string): Promise<TaskModel> {
  ...
  async updateTask(id: string, updateTaskDto: Partial<CreateTaskDto>): Promise<TaskModel> {
